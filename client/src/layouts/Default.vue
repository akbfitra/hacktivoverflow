<template>
  <q-layout view="hHh LpR fFf">
    ...
    <q-header elevated class="bg-orange-5 text-black">
      <q-toolbar>
        ...
        <div v-if="isLogin" class="YL__toolbar-input-container row no-wrap">
          <q-input dense outlined square v-model="search" placeholder="Search" class="bg-white col" />
          <q-btn @click.prevent="searchtitle" class="YL__toolbar-input-btn" color="grey-3" text-color="grey-8" icon="search" unelevated />
        </div>
        <q-space />
        ...
        <div v-if="!isLogin">
          <q-btn 
            to="/login"
            exact
            outline style="color: black; margin-right:5px;" 
          ...
          <q-btn to="/register"
            exact
            outline style="color: black;" icon-right="control_point" label="Register" />
        </div>
      ...
      <q-scroll-area class="fit">
        <q-list  padding>
          ...
          exact >
            ...
            <q-item-section>
              <q-item-label>My Question</q-item-label>
            </q-item-section>
          </q-item>
          <q-item to="/pending"
          exact >
