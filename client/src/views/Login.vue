    ...
    <q-card square class="shadow-24" style="width:700px;height:450px;">
      <q-card-section class="bg-orange-5">
        ...
        <div class="absolute-bottom-right q-pr-md" style="transform: translateY(50%);">
          <q-btn to="/register" exact fab icon="add" color="orange-7"/>
        </div>
      </q-card-section>
      <q-card-section>
      ...
      <q-card-actions class="q-px-lg">
        <q-btn @click.prevent="kliklogin" unelevated size="lg" color="orange-14" class="full-width text-white" label="Sign In" />
      </q-card-actions>
    </q-card>
  </q-page>
  </div>
